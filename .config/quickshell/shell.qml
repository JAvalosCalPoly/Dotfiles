...
ShellRoot {
    ...
    id: root
    property bool diskPopupOpen: false
        ...
        PanelWindow {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    DiskWidget {
                       Layout.rightMargin: 8
                       onClicked: diskPopupOpen = !diskPopupOpen
                    }
    ...
    // Add the dock as a child of the shell root
    // PanelWindow {
    //     id: dockWindow
    //     property var modelData
    //     screen: modelData
    ...
    //     // ✅ reserve space only while dock is shown
    //     exclusiveZone: dock.showDock ? dock.reservedHeight : 10
    // }
}